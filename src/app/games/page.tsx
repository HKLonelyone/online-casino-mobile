...
const GamePage: React.FC = () => {
  ...
  const games = [
    { id: 1, name: '百家樂', icon: '🃏', category: '棋牌' },
    { id: 2, name: '老虎機', icon: '🎰', category: '老虎機' },
    { id: 3, name: '輪盤', icon: '🎡', category: '桌遊' },
    { id: 4, name: '德州撲克', icon: '♠️', category: '棋牌' },
    { id: 5, name: '21點', icon: '🂡', category: '桌遊' },
    { id: 6, name: '骰寶', icon: '🎲', category: '桌遊' },
    { id: 7, name: '水果機', icon: '🍉', category: '老虎機' },
    { id: 8, name: '魚蝦蟹', icon: '🦐', category: '桌遊' },
    { id: 9, name: '麻將', icon: '🀄', category: '棋牌' },
  ];
